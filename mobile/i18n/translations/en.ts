const locale = {
  ...
  'eam.descriptions.1':
    'Bay Baby Maintenance’s Enterprise Asset Management module can be used for anywhere between 10 to 1,000,000 Assets, allowing you to track exactly what you want, the way you want to, in an easy-to-use and searchable tree structure.',
  'eam.checks.0':
  ...
  confirm_delete_inspection: 'Are you sure you want to delete this inspection?',
  ...
  fleet: 'Tractors/Vehicles',
  fleet_management: 'Tractors/Vehicles',
  tagout: 'Tagout',
  scan: 'Scan',
  search_fleet: 'Search vehicles',
  add_vehicle: 'Add Vehicle',
  vehicle_name: 'Vehicle name',
  required_vehicle_name: 'Vehicle name is required',
  vehicle_created: 'Vehicle added',
  vehicle_create_failure: 'Could not add the vehicle',
  no_vehicles: 'No vehicles yet',
  no_vehicles_hint: 'Add the first vehicle to begin managing the fleet.',
  ...
  usage_value_required: 'Enter a usage value greater than zero',
  usage_date_required: 'Enter the week as YYYY-MM-DD',
  usage_save_failure: 'Could not save the usage entry',
  delete_usage_log: 'Delete this usage entry?',
  add_tagout: 'Add Tagout',
  tagout_title: 'Tagout title',
  isolation_point: 'Isolation point',
  isolation_procedure: 'Isolation procedure',
  tagout_required: 'Title and isolation point are required',
  tagout_created: 'Tagout created',
  tagout_create_failure: 'Could not create the tagout',
  release_tagout: 'Release tagout',
  ...
  asset_scan_result: 'Scanned Asset',
  submit_request_for_asset: 'Submit Request',
  create_work_order_for_asset: 'Create Work Order',
